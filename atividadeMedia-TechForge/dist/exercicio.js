...
function separarNotas(notas, aprovados, exame, reprovados) {
    for (let i = 0; i < notas.length; i++) {
        const nota = notas[i];
...
function gerarRelatorio(aprovados, exame, reprovados) {
    console.log("\n============================================");
...
function executarProcessamento() {
    ...
    const reprovados = [];
    // 3. Triagem das notas.
    separarNotas(notas, aprovados, exame, reprovados);
    ...
    gerarRelatorio(aprovadosOrdenados, exameOrdenado, reprovadosOrdenados);
}
